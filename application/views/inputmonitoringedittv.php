      ...
      <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
        ...
        <ul class="nav nav-list">
          <li class="active open">
            <a href="javascript:history.back()" class="dropdown-toggle">
...
<br>
            <div class="row">
              <div class="col-xs-12">
              <?php foreach ($tb_pelanggaran as $u) { ?>
              <form action="<?php echo base_url(). 'inputmonitoring/updatetv'; ?>" method="post" class="form-horizontal" role="form">
              <input type="hidden" name="id_pelanggaran" value="<?php echo $u->id_pelanggaran ?>">
                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Tgl Pelanggaran </label>

                    <div class="col-sm-9">
                      <span class="input-icon input-icon-right">
                        <input class="form-control date-picker" data-date-format="yyyy-mm-dd" name="tgl_pelanggaran" value="<?php echo $u->tgl_pelanggaran ?>" type="text" id="form-field-icon-2" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" value="<?php echo $u->station_tv2 ?>" name="station_tv2" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" value="<?php echo $u->pelanggaran ?>" name="pelanggaran" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
                  ...
                  <!-- div class="form-group">
                    ...
                    <option value="<?php //echo $u->jenis_program ?>" hidden><?php //echo $u->jenis_program ?></option>
                  ...
                  <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Jenis Pelanggaran </label>&nbsp;&nbsp;
                          <label>
                            <input id="munculacara" name="jenis_pelanggaran" type="radio" value="Acara"<?php //if ($u->jenis_pelanggaran=="Acara") { echo "checked=\"checked\""; } ?> class="ace" />
                            <span class="lbl"> Acara </span>
                          </label>&nbsp;&nbsp;&nbsp;
                          <label>
                            <input id="munculiklan" name="jenis_pelanggaran" type="radio" value="Iklan"<?php //if ($u->jenis_pelanggaran=="Iklan") { echo "checked=\"checked\""; } ?> class="ace" />
                            <span class="lbl"> Iklan </span>
                          </label>&nbsp;&nbsp;&nbsp;
                          <label>
                            <input id="munculstation" name="jenis_pelanggaran" type="radio" value="Station TV"<?php //if ($u->jenis_pelanggaran=="Station TV") { echo "checked=\"checked\""; } ?> class="ace" />
                            <span class="lbl"> Station TV </span>
                          </label>&nbsp;&nbsp;&nbsp;
                          <label>
                            <input id="munculradio" name="jenis_pelanggaran" type="radio" value="Station Radio"<?php //if ($u->jenis_pelanggaran=="Station Radio") { echo "checked=\"checked\""; } ?> class="ace" />
                    ...
                    <div class="col-md-offset-3 col-md-9">
                      ...
                      &nbsp;&nbsp;
                      <button class="btn btn-info" href="javascript:history.back()">
