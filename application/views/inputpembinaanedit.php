...
<br>
            <div class="row">
              <div class="col-xs-12">
              <?php foreach ($tb_pembinaan as $u) { ?>
              <form action="<?php echo base_url(). 'inputpembinaan/update'; ?>" method="post" class="form-horizontal" role="form">
              <input type="hidden" name="id_pembinaan" value="<?php echo $u->id_pembinaan ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Pembinaan </label>

                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" name="pembinaan" value="<?php echo $u->pembinaan ?>" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
