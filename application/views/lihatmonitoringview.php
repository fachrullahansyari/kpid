              ...
              <table id="simple-table" class="table  table-bordered table-hover">
                      <thead>
                        <tr>
                          ...
                          <th><i class="ace-icon fa fa-list hidden-480"></i>Jenis Pelanggaran</th>
                          <th><i class="ace-icon fa fa-list hidden-480"></i>Uraian Pelanggaran</th>
                      ...
                      <td><?php echo $u->jenis_pelanggaran ?></td>
                      <td><?php echo $u->uraian_pelanggaran ?></td>
                      <td><?php echo anchor('inputmonitoring/edit/'.$u->id_pelanggaran,'<button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button>'); ?>&nbsp;&nbsp;<?php echo anchor('inputmonitoring/hapus/'.$u->id_pelanggaran,'<button class="btn btn-xs btn-danger"><i class="ace-icon fa fa-trash-o bigger-120"></button>'); ?></i></td>
                      </tr>
                      <?php } ?>
                      </tbody>
              </table>
