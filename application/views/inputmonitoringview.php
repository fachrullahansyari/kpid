...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('asset/assets/css/bootstrap-datepicker3.min.css')?>" />
...
<br>
            <div class="row">
              <div class="col-xs-12">
              <form action="<?php echo base_url(). 'inputmonitoring/tambah_aksi'; ?>" method="post" class="form-horizontal" role="form">
                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tgl Pelanggaran</label>

                    <div class="col-sm-9">
                      <span class="input-icon input-icon-right">
                        <input class="form-control date-picker" data-date-format="yyyy-mm-dd" name="tgl_pelanggaran" placeholder="<?php echo date('Y-m-d'); ?>" type="text" id="form-field-icon-2" />
                  ...
                  <!-- div class="form-group">
                    ...
                    <div class="col-sm-9">
                              <select class="col-xs-10 col-sm-3" name="jenis_program" id="form-field-select-1">
                  ...
                  <div class="form-group">
                  <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Jenis Pelanggaran </label>&nbsp;&nbsp;
                          <label>
                            <input id="munculacara" name="jenis_pelanggaran" type="radio" value="Acara" class="ace" />
                            <span class="lbl"> Acara </span>
                          </label>&nbsp;&nbsp;&nbsp;
                          <label>
                            <input id="munculiklan" name="jenis_pelanggaran" type="radio" value="Iklan" class="ace" />
                            <span class="lbl"> Iklan </span>
                          </label>&nbsp;&nbsp;&nbsp;
                          <label>
                            <input id="munculstation" name="jenis_pelanggaran" type="radio" value="Station TV" class="ace" />
                            <span class="lbl"> Station TV </span>
                          </label>&nbsp;&nbsp;&nbsp;
                          <label>
                            <input id="munculradio" name="jenis_pelanggaran" type="radio" value="Station Radio" class="ace" />
                            <span class="lbl"> Station Radio </span>
                          </label>
                  </div>

                  <div id="hiddenacara" style="display:none" class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Station TV </label>

                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" placeholder="Nama Station TV" name="station_tv" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>

                  <div id="hiddenacara1" style="display:none" class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Acara </label>

                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" placeholder="Nama Acara TV" name="nama_acara" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>

                  <div id="hiddeniklan" style="display:none" class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Station TV </label>

                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" placeholder="Nama Station TV" name="station_tv1" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>

                  <div id="hiddeniklan1" style="display:none" class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Iklan </label>

                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" placeholder="Nama Iklan" name="nama_iklan" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>

                  <div id="hiddenstation" style="display:none" class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Station TV </label>

                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" placeholder="Nama Station TV" name="station_tv2" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>

                  <div id="hiddenstation1" style="display:none" class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Pelanggaran </label>

                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" placeholder="Isi Pelanggaran" name="pelanggaran" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>

                  <div id="hiddenradio" style="display:none" class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Radio </label>

                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" placeholder="Nama Radio" name="nama_radio" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>

                  <div id="hiddenradio1" style="display:none" class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Acara </label>

                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" placeholder="Nama Acara Radio" name="acara_radio" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Uraian Pelanggaran </label>

                    <div class="col-sm-9">
                    <textarea class="col-xs-10 col-sm-5" name="uraian_pelanggaran" id="form-field-8" placeholder="Uraian Pelanggan"></textarea>
                    </div>
                  </div>
...
<![endif]-->
    ...
    <script src="<?php echo base_url('asset/assets/js/bootstrap-datepicker.min.js')?>"></script>
