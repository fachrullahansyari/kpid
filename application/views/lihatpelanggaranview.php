...
<!-- content mulai -->
            <div class="row">
              ...
              <table id="simple-table" class="table  table-bordered table-hover">
                      ...
                      <td><?php echo $u->station_tv ?></td>
                      <td><?php echo $u->nama_acara ?></td>
                      <td><?php echo anchor('inputmonitoring/editrkp/'.$u->id_pelanggaran,'<button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button>'); ?>&nbsp;&nbsp;<?php echo anchor('inputmonitoring/hapusrkp/'.$u->id_pelanggaran,'<button class="btn btn-xs btn-danger"><i class="ace-icon fa fa-trash-o bigger-120"></button>'); ?></i></td>
                      </tr>
                      <?php } ?>
                      <tr>
                      <?php
