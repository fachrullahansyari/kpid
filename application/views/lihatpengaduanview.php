            ...
            <div class="row">
              ...
              <table id="simple-table" class="table  table-bordered table-hover">
                      <thead>
                        <tr>
                          <th>No</th>
                          <th><i class="ace-icon fa fa-list hidden-480"></i>Tgl Pengaduan</th>
                      ...
                      <?php
                      $no = 1;
                      foreach ($tb_pengaduan as $u) { 
                      ?>
                      <tr>
                      <td><?php echo $no++ ?></td>
                      <td><?php echo $u->tgl_pengaduan ?></td>
                      <td><?php echo $u->nama_program ?></td>
                      <td><?php echo $u->jenis_program ?></td>
                      <td><?php echo anchor('inputpengaduan/edit/'.$u->id_pengaduan,'<button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button>'); ?>&nbsp;&nbsp;<?php echo anchor('inputpengaduan/hapus/'.$u->id_pengaduan,'<button class="btn btn-xs btn-danger"><i class="ace-icon fa fa-trash-o bigger-120"></button>'); ?></i></td>
                      </tr>
                      <?php } ?>
                      </tbody>
              </table>
