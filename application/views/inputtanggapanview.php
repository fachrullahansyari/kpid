...
<br>
            <div class="row">
              <div class="col-xs-12">
              <form action="<?php echo base_url(). 'inputtanggapan/tambah_aksi'; ?>" method="post" class="form-horizontal" role="form">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <textarea class="col-xs-10 col-sm-5" name="isi" id="form-field-8" placeholder="Isi"></textarea>
                    </div>
                  </div>
