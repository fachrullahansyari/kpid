...
<br>
            <div class="row">
              <div class="col-xs-12">
              <?php foreach ($tb_tanggapan as $u) { ?>
              <form action="<?php echo base_url(). 'inputtanggapan/update'; ?>" method="post" class="form-horizontal" role="form">
              <input type="hidden" name="id_tanggapan" value="<?php echo $u->id_tanggapan ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" name="isi" value="<?php echo $u->isi ?>" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
