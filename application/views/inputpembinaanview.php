...
<br>
            <div class="row">
              <div class="col-xs-12">
              <form action="<?php echo base_url(). 'inputpembinaan/tambah_aksi'; ?>" method="post" class="form-horizontal" role="form">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" name="pembinaan" placeholder="Pembinaan" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
