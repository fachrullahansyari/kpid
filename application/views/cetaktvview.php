      ...
      <div class="main-content">
        <div class="main-content-inner">
          <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
              <li class="active">Komisi Penyiaran Indonesia Daerah Kalimantan Selatan</li>
            </ul><!-- /.breadcrumb -->
          ...
          <div class="page-content">
            ...
            <br>
              <h1>
                Laporan Rekapitulasi Pelanggaran Station TV
              </h1>
              <br>
              <br>
            </div><!-- /.page-header -->
...
<!-- content mulai -->
            <div class="row">
              ...
              <table id="simple-table" class="table  table-bordered table-hover">
                      ...
                      ?>
                      <td colspan="4"> Jumlah Pelanggaran :&nbsp; <?php echo $c->JML ?> </td>
                      </tr>
                      <?php } ?>
                      </tbody>
              </table>
