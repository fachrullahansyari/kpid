...
<br>
            <div class="row">
              <div class="col-xs-12">
              <?php foreach ($tb_pengaduan as $u) { ?>
              <form action="<?php echo base_url(). 'inputpengaduan/update'; ?>" method="post" class="form-horizontal" role="form">
              <input type="hidden" name="id_pengaduan" value="<?php echo $u->id_pengaduan ?>">
                  <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Tgl Pengaduan </label>

                    <div class="col-sm-9">
                      <span class="input-icon input-icon-right">
                        <input class="form-control date-picker" data-date-format="yyyy-mm-dd" name="tgl_pengaduan" value="<?php echo $u->tgl_pengaduan ?>" type="text" id="form-field-icon-2" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" name="nama_program" value="<?php echo $u->nama_program ?>" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
