...
<!-- content mulai -->
            <div class="row">
              <div class="col-xs-12">
                  ...
                  <div class="col-sm-9">
                  <form action="<?php echo site_url('tescari/cari');?>" method="get">
                  <input type="text" name="cari" class="col-xs-8 col-sm-3" placeholder="Cari Nama Program">
              ...
              <table id="simple-table" class="table  table-bordered table-hover">
                      <thead>
                        <tr>
                          ...
                          <th><i class="ace-icon fa fa-list hidden-480"></i>Pembinaan</th>
                          <th><i class="ace-icon fa fa-list hidden-480"></i>Action</th>
                        </tr>
                      </thead>
                      <tbody>
                      <?php
                      if(count($tb_pembinaan)>0){
                      $no = 1;
                      foreach($tb_pembinaan as $u){?>
                      <tr>
                      <td><?php echo $no++ ?></td>
                      <td><?php echo $u->nama_program ?></td>
                      <td><?php echo $u->jenis_program ?></td>
                      <td><?php echo $u->pembinaan ?></td>
                      <td><?php echo anchor('inputpembinaan/edit/'.$u->id_pembinaan,'<button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button>'); ?>&nbsp;&nbsp;<?php echo anchor('inputpembinaan/hapus/'.$u->id_pembinaan,'<button class="btn btn-xs btn-danger"><i class="ace-icon fa fa-trash-o bigger-120"></button>'); ?></i></td>
                      </tr>
                      <?php }}else{ ?>
                      <tr>
