        ...
        <ul class="nav nav-list">
          <li class="">
            <a href="#" class="dropdown-toggle">
              ...
              <span class="menu-text"> NOT FOUND </span>              
            </a>
...
<!-- content mulai -->
            <div class="row">
              ...
              <br>
          <div class="clearfix">
            <a class="btn btn-primary float-right" href="javascript:history.back()"><i class="ace-icon fa fa-arrow-left bigger-110">KEMBALI</i></a>
          </div>
              </div>
              </div>
              <br>
