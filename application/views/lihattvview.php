            ...
            <div class="page-header">
              <h1>
                ...
                <small>
                  ...
                  Data Rekap Pelanggaran Station TV
                </small>
              </h1>
            </div><!-- /.page-header -->
              ...
              <table id="simple-table" class="table  table-bordered table-hover">
                      <thead>
                        <tr>
                          ...
                          <th><i class="ace-icon fa fa-list hidden-480"></i>Station TV</th>
                          <th><i class="ace-icon fa fa-list hidden-480"></i>Pelanggaran</th>
                      ...
                      <td><?php echo $u->station_tv2 ?></td>
                      <td><?php echo $u->pelanggaran ?></td>
                      <td><?php echo anchor('inputmonitoring/edittv/'.$u->id_pelanggaran,'<button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button>'); ?>&nbsp;&nbsp;<?php echo anchor('inputmonitoring/hapustv/'.$u->id_pelanggaran,'<button class="btn btn-xs btn-danger"><i class="ace-icon fa fa-trash-o bigger-120"></button>'); ?></i></td>
                      </tr>
                      <?php } ?>
                      <tr>
                      <?php
