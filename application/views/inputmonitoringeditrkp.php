...
<br>
            <div class="row">
              ...
              <form action="<?php echo base_url(). 'inputmonitoring/updaterkp'; ?>" method="post" class="form-horizontal" role="form">
              <input type="hidden" name="id_pelanggaran" value="<?php echo $u->id_pelanggaran ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" value="<?php echo $u->station_tv ?>" name="station_tv" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" value="<?php echo $u->nama_acara ?>" name="nama_acara" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
