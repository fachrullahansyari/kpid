        ...
        <div class="main-content-inner">
          <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
              ...
              <li class="active">Lihat Rekapitulasi</li>
            </ul><!-- /.breadcrumb -->
            ...
            <div class="page-header">
              <h1>
                ...
                <small>
                  ...
                  Data Rekap Pelanggaran Station Radio
                </small>
              </h1>
            </div><!-- /.page-header -->
            ...
            <div class="row">
              ...
              <table id="simple-table" class="table  table-bordered table-hover">
                      <thead>
                        <tr>
                          <th>No</th>
                          <th><i class="ace-icon fa fa-list hidden-480"></i>Tgl Pelanggaran</th>
                          <th><i class="ace-icon fa fa-list hidden-480"></i>Nama Radio</th>
                          <th><i class="ace-icon fa fa-list hidden-480"></i>Nama Acara</th>
                      ...
                      <?php
                      $no = 1;
                      foreach ($tb_pelanggaran as $u) { 
                      ?>
                      <tr>
                      <td><?php echo $no++ ?></td>
                      <td><?php echo $u->tgl_pelanggaran ?></td>
                      <td><?php echo $u->nama_radio ?></td>
                      <td><?php echo $u->acara_radio ?></td>
                      <td><?php echo anchor('inputmonitoring/editradio/'.$u->id_pelanggaran,'<button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button>'); ?>&nbsp;&nbsp;<?php echo anchor('inputmonitoring/hapusradio/'.$u->id_pelanggaran,'<button class="btn btn-xs btn-danger"><i class="ace-icon fa fa-trash-o bigger-120"></button>'); ?></i></td>
                      </tr>
                      <?php } ?>
                      <tr>
                      <?php
                      $no = 1;
                      foreach ($tb_pelanggaran1 as $c) { 
                      ?>
                      <td colspan="5"> Jumlah Pelanggaran :&nbsp; <?php echo $c->JML ?> </td>
                      </tr>
                      <?php } ?>
                      </tbody>
              </table>
