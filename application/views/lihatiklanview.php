              ...
              <table id="simple-table" class="table  table-bordered table-hover">
                      <thead>
                        <tr>
                          ...
                          <th><i class="ace-icon fa fa-list hidden-480"></i>Nama Iklan</th>
                      ...
                      <td><?php echo $u->station_tv1 ?></td>
                      <td><?php echo $u->nama_iklan ?></td>
                      <td><?php echo anchor('inputmonitoring/editikl/'.$u->id_pelanggaran,'<button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button>'); ?>&nbsp;&nbsp;<?php echo anchor('inputmonitoring/hapusikl/'.$u->id_pelanggaran,'<button class="btn btn-xs btn-danger"><i class="ace-icon fa fa-trash-o bigger-120"></button>'); ?></i></td>
                      </tr>
                      <?php } ?>
                      <tr>
                      <?php
