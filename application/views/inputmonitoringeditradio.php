...
<br>
            <div class="row">
              ...
              <form action="<?php echo base_url(). 'inputmonitoring/updateradio'; ?>" method="post" class="form-horizontal" role="form">
              <input type="hidden" name="id_pelanggaran" value="<?php echo $u->id_pelanggaran ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" value="<?php echo $u->nama_radio ?>" name="nama_radio" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" value="<?php echo $u->acara_radio ?>" name="acara_radio" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
