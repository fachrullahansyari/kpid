...
<br>
            <div class="row">
              ...
              <form action="<?php echo base_url(). 'inputmonitoring/updateikl'; ?>" method="post" class="form-horizontal" role="form">
              <input type="hidden" name="id_pelanggaran" value="<?php echo $u->id_pelanggaran ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" value="<?php echo $u->station_tv1 ?>" name="station_tv1" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                    <input type="text" id="form-field-1" value="<?php echo $u->nama_iklan ?>" name="nama_iklan" class="col-xs-10 col-sm-5" />
                    </div>
                  </div>
